...
angular.module('App').controller('rentHouseDetailCtl',function($ionicScrollDelegate,$ionicModal,$timeout,$ionicHistory,$scope,$state,$stateParams,$http,$Factory,$ionicSlideBoxDelegate,$ionicPopover,$timeout,$ionicLoading,WechatService,Apphost){
	$timeout(function(){
	...
	//把浮动框读取到作用域中
	// .fromTemplateUrl() 方法
	$ionicPopover.fromTemplateUrl('rentHouseDetailpopover.html', {
	    scope: $scope
	...
	$scope.Base64=function(shareto){
		var mycans = document.getElementById("rent_house_detailmycans");
