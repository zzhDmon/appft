...
// angular.module('App').controller('ChatController',function($timeout,$ionicHistory,$http,$Factory,$scope,$stateParams,$ionicPopover,$ionicScrollDelegate){
	
// 	$scope.listen=function(){
// 		var listener = function (msg) {
// 			alert('logsuc'+JSON.stringify(msg))
// 		}
...
// 			JMessage.login({ username: $scope.user.username, password: $scope.user.password },
// 			(suc) => {
...
// 		text:''
// 	}
// 	$scope.towho=function(){
// 		JMessage.sendTextMessage({ type: 'single', username: $scope.send.username, appKey: '',
// 			text: $scope.send.text, extras: {key1: 'value1'}, messageSendingOptions: JMessage.messageSendingOptions },
// 			(msg) => {
// 				// do something.
// 			}, (err) => {
// 				alert('senderr'+JSON.stringify(err))
// 				alert(JSON.stringify(JMessage.messageSendingOptions))
// 			})
// 	}
...
// 		JMessage.getMessageById({type:'single',username:$scope.get.username,appKey:'',messageId:'1'},
// 					(msg)=>{
...
// })
angular.module('App').controller('ChatController', ['$scope', '$rootScope', '$state',
