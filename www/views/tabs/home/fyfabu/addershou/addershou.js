...
angular.module('App').controller('AddershouController',function($ionicLoading,$ionicHistory,$timeout,$http,$Factory,$scope,$rootScope,$stateParams,$ionicPopover,$timeout){
	//是否缓存
