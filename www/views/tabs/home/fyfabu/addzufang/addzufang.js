...
angular.module('App').controller('AddzufangController',function($ionicLoading,$ionicHistory,$http,$Factory,$rootScope,$scope,$stateParams,$ionicPopover,$timeout){
	setTimeout(function(){
	...
	$scope.headtitle = '租房'+$scope.title;
