...
angular.module('App').controller('SettingController',function($timeout,$ionicHistory,$cordovaAppVersion,$cordovaFileTransfer, $cordovaFile, $cordovaFileOpener2,$rootScope,$http,$Factory,$state,$scope,$stateParams,$ionicPopup,$ionicLoading){
	$timeout(function(){
