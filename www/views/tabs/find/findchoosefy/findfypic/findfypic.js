...
angular.module('App').controller('FindFypicController',function($Factory,$ionicHistory,$scope,$stateParams,$ionicPopover,$timeout,WechatService,$ionicLoading,Apphost){
	...
	//把浮动框读取到作用域中
	$ionicPopover.fromTemplateUrl('findfypicpopover.html', {
	    scope: $scope
	...
	$scope.Base64=function(shareto){
		var mycans = document.getElementById("findfypicmycans");
