angular.module('App').controller('InfoController',function($ionicScrollDelegate,$rootScope,$ionicHistory,$Factory,$scope,$http,$ionicLoading,$ionicSideMenuDelegate,$ionicSlideBoxDelegate){
	...
	$scope.showbacktopbtn=function(scrollTop){
		if(scrollTop>1500){
			$('#info .backtop').css('display','block')
		}else{
			$('#info .backtop').css('display','none')
		}
	}
