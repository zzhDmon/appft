angular.module('App').controller('houseClassCtl',function($timeout,$ionicScrollDelegate,$rootScope,$ionicHistory,$Factory,$scope,$http,$ionicLoading,$ionicSideMenuDelegate,$ionicSlideBoxDelegate){
