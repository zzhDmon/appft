...
angular.module('App').controller('agentListCtl',function($ionicLoading,$ionicHistory,$state,$http,$Factory,$scope,$stateParams,$ionicPopover,$ionicPopup,$timeout,$ionicActionSheet){
	$timeout(function(){
